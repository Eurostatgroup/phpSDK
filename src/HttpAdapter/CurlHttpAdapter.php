...
use Eurostatgroup\Api\Exceptions\CurlConnectTimeoutException;
...
final class CurlHttpAdapter implements HttpAdapterInterface
{
    ...
    protected function attemptRequest($httpMethod, $url, $headers, $httpBody)
    {
        ...
        switch ($httpMethod) {
            case EurostatgroupClient::HTTP_POST:
                curl_setopt($curl, CURLOPT_POST, true);
                curl_setopt($curl, CURLOPT_POSTFIELDS,  $httpBody);

                break;
            case EurostatgroupClient::HTTP_GET:
                break;
            case EurostatgroupClient::HTTP_PUT:
                curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'PUT');
                curl_setopt($curl, CURLOPT_POSTFIELDS, $httpBody);

                break;
            case EurostatgroupClient::HTTP_DELETE:
